...
static ULONG ultrasatan_getdt(void)
{
    ...
    KDEBUG(("ultrasatan_getdt(): read clock value %04d-%02d-%02d %02d:%02d:%02d\n", dskbufp[3], month, day, hour, minute, second));
