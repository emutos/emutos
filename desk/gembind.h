...
#define AP_PTREE   (*(ULONG_ALIAS *)&global[5])     /* ptr to array of tree addresses */
                                        /* the following usage is not advertised */
#define AP_1RESV   (*(ULONG_ALIAS *)&global[7])     /* address of rsc file in memory */
#define AP_2RESV0  global[9]                        /* length of rsc file */
#define AP_2RESV1  global[10]                       /* # of colour planes on screen */
#define AP_3RESV   (*(ULONG_ALIAS*)&global[11])     /* ptr to AES global area D (struct THEGLO) */
